...
<div class="intro">
	...
	<p>
		Le Professeur Chen a perdu toutes ses données sur les pokémons après que son disque dur ait
		rendu l'âme. Il n'a pas fait de backup alors il espère que vous pourrez l'aider à reconstituer
		une partie de ses données grâce à vos connaissances extensives des pokémons ! <br /> Saurez-vous
		retrouver le nom de tous ces pokémons ?
	</p>
</div>
